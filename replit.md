...
## Recent Changes
- **Parlay Prediction Debug Enhancement (2025-08-03)**: Added comprehensive debugging to both frontend and backend for parlay creation. Enhanced mutation error handling with detailed console logging to identify the root cause of "Failed to create parlay prediction" error that persists despite schema fixes and extensive backend debugging.
