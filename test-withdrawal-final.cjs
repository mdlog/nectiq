...
/**
 * Final Test Multi Token Vault Withdrawal
 */
...
async function testWithdrawalFinal() {
    try {
        console.log('🧪 Final Test Multi Token Vault Withdrawal');
        console.log('==========================================');
        ...
        // Use a valid test address (this is a known valid address from Polygon Amoy)
...
testWithdrawalFinal().catch(console.error);
