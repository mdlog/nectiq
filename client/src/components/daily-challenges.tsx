...
function getChallengeIcon(type: string, isCompleted: boolean) {
  const iconClass = `w-6 h-6 ${isCompleted ? 'text-green-500' : 'text-gray-400'}`;
  ...
  return (
    <div className="space-y-6">
          ...
          <CardContent className="p-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold">{completedToday.length}/{todaysChallenges.length}</p>
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      {challengeHistory.length > 0 && (
        <div>
          <h3 className="text-lg font-semibold mb-4">Recent Challenge History</h3>
          <div className="space-y-2">
